<template>
    <div>
           <div class="case-child-end1 flex">
                                                <div> <el-button type="danger" round @click="toAdd()"><i class="el-icon-plus"></i>添加客户类型</el-button></div>
                                                </div>
                                                <div class="showTab">
                                                <ul class="showTab-ul">
                                                <li class="showTab-li">
                                                ...
                                                <el-table-column prop="Value" label="客户类型名称" width=""> </el-table-column>
                                                ...
                                                <template slot-scope="scope">
                                                <button class="btn-caozuo"  @click="getCustomeTypeInfo(scope.row.Id)">编辑</button>
                                                <button class="btn-caozuo" @click="deleteCustomeType(scope.row.Id)">删除</button>
                                                </template>
                                                </el-table-column>    
                                            </el-table>
                        ...
                        <div slot="footer" class="dialog-footer">
                          ...
                          <el-button type="primary" @click="addCustomeType()">确 定</el-button>
                        </div>
                     ...
                     <div class="dialogFormVisivleHeader_left flex">添加客户类型</div>
                        ...
                        <div slot="footer" class="dialog-footer">
                          ...
                          <el-button type="primary" @click="updataCustomeType()">确 定</el-button>
                        </div>
                         <div slot="title" class="dialog-title">
...
export default {
    ...
    methods:{
      ...
      getCustomeTypeList(){ 
         ...
         this.$http.get('/yongxu/Install/Show_Customer_Type',{params:{
           Display_Page_Number:this.numPage,
           PageNumber:this.currentPage,
         }}).then((res)=>{
           this.tableData = res.data.Customer_Type
