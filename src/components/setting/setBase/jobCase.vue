<template>
    <div>
           <div class="case-child-end1 flex">
                                                <div> <el-button type="danger" round @click="toAdd()"><i class="el-icon-plus"></i>添加职务</el-button></div>
                                                </div>
                                                <div class="showTab">
                                                <ul class="showTab-ul">
                                                <li class="showTab-li">
                                                ...
                                                <el-table-column prop="Position_Name" label="职务" width=""> </el-table-column>
                                                  <el-table-column prop="Describe" label="描述" width=""> </el-table-column>
                                                ...
                                                <template slot-scope="scope">
                                                <button class="btn-caozuo"  @click="getJobTypeInfo(scope.row.Id)">编辑</button>
                                                <button class="btn-caozuo" @click="deleteJobType(scope.row.Id)">删除</button>
                                                </template>
                                                </el-table-column>    
                                            </el-table>
                     ...
                     <div class="dialogFormVisivleHeader_left flex">添加职务</div>
                         ...
                         <div class="dialogFormVisible_box">
                          ...
                          <div class="flex row margin_t">
                            ...
                            <input type="text" class="this_input" v-model="update_Describe">
...
export default {
    ...
    methods:{
      ...
      getJobTypeList(){ 
         ...
         this.$http.get('/yongxu/Install/Show_Position',{params:{
      ...
      //修改案件类型
        ...
        if(this.update_name == '' || this.update_name == null){
           ...
           this.$http.get('/yongxu/Install/Upd_Position',{params:{User_Id:localStorage.getItem('userId'),Id:this.Id,Position_Name:this.update_name,Describe:this.update_Describe}}).then((res)=>{         
                if(res.data == true){
                     this.getJobTypeList()
                      this.$message({
                      type: 'success',
